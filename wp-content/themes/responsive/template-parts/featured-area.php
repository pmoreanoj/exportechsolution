...
<div id="featured" class="grid col-940">
	...
	<div id="featured-image" class="grid col-460 fit">
		...
		<?php $featured_content = ( !empty( $responsive_options['featured_content'] ) ) ? $responsive_options['featured_content'] : '<img class="aligncenter" src="http://www.exportechsolution.com/wp-content/uploads/2016/05/hp_image.png" width="440" height="300" alt="" />'; ?>
