...
//Add a class for titles
	...
	$wp_customize->add_section(
        'logo_sec',
        array(
            'title' => __('Logo (PRO Version)', 'precious-lite'),
            'priority' => 1,
            'description' => __('<strong>Logo and favicon Settings available in</strong>','precious-lite').' <a href="'.esc_url(precious_lite_pro_theme_url).'" target="_blank">'.__('PRO Version','precious-lite').'</a>.',
        )
    );  
