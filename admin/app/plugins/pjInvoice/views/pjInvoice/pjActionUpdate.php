	...
	<form action="<?php echo PJ_INSTALL_URL; ?>index.php?controller=pjInvoice&amp;action=pjActionUpdate" method="post" class="pj-form form" id="frmUpdateInvoice">
		...
		<div id="tabs">
			<ul>
				...
				<li class="plugin_view_invoice"><a href="<?php echo PJ_INSTALL_URL; ?>?controller=pjInvoice&amp;action=pjActionView&amp;id=<?php echo $tpl['arr']['uuid']; ?>&amp;uuid=<?php echo $tpl['arr']['order_id']; ?>" target="_blank"><?php __('plugin_invoice_i_invoice'); ?></a></li>
			</ul>
			<div id="tabs-1">
			...
			<div id="tabs-2">
				...
				<fieldset class="fieldset white">
					...
					<p>
						...
						<span class="left">
							<input type="text" name="b_company" id="b_company" class="pj-form-field w500" value="<?php echo htmlspecialchars(stripslashes(@$tpl['arr']['b_company'])); ?>" />
						</span>
					</p>
					<p>
