				...
				<table class="pj-table b10" cellpadding="0" cellspacing="0" style="width: 100%">
					...
					<tbody>
						...
						<tr class="boxPaypal" style="display: <?php echo (int) $tpl['arr']['p_accept_paypal'] === 1 ? NULL : 'none'; ?>">
							...
							<td><input type="text" name="p_paypal_address" class="pj-form-field w200" value="<?php echo htmlspecialchars(stripslashes($tpl['arr']['p_paypal_address'])); ?>" /></td>
						</tr>
						<tr>
						...
						<tr class="boxAuthorize" style="display: <?php echo (int) $tpl['arr']['p_accept_authorize'] === 1 ? NULL : 'none'; ?>">
							...
							<td><input type="text" name="p_authorize_key" class="pj-form-field w200" value="<?php echo htmlspecialchars(stripslashes($tpl['arr']['p_authorize_key'])); ?>" /></td>
						</tr>
						<tr class="boxAuthorize" style="display: <?php echo (int) $tpl['arr']['p_accept_authorize'] === 1 ? NULL : 'none'; ?>">
							<td><?php __('plugin_invoice_i_authorize_mid'); ?></td>
							<td><input type="text" name="p_authorize_mid" class="pj-form-field w200" value="<?php echo htmlspecialchars(stripslashes($tpl['arr']['p_authorize_mid'])); ?>" /></td>
						</tr>
						<tr class="boxAuthorize" style="display: <?php echo (int) $tpl['arr']['p_accept_authorize'] === 1 ? NULL : 'none'; ?>">
							<td><?php __('plugin_invoice_i_authorize_hash'); ?></td>
							<td><input type="text" name="p_authorize_hash" class="pj-form-field w200" value="<?php echo htmlspecialchars(stripslashes($tpl['arr']['p_authorize_hash'])); ?>" /></td>
						</tr>
						<tr>
						...
						<tr class="boxBank" style="display: <?php echo (int) $tpl['arr']['p_accept_bank'] === 1 ? NULL : 'none'; ?>">
							...
							<td><textarea name="p_bank_account" class="pj-form-field w250 h50"><?php echo htmlspecialchars(stripslashes($tpl['arr']['p_bank_account'])); ?></textarea></td>
						</tr>
						<tr>
